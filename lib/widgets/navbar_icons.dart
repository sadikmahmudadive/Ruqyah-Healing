...
/// Modern Home Navigation Icon with smooth geometric arches and dual active/inactive states
...
class _HomeIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isSelected) {
      // Modern Solid Home with smooth apex and micro inner archway
      final Path house = Path()
        ..moveTo(12.0, 2.8)
        ..cubicTo(12.6, 2.8, 13.2, 3.2, 13.6, 3.6)
        ..lineTo(20.4, 9.4)
        ..cubicTo(21.1, 10.0, 21.4, 10.7, 21.4, 11.5)
        ..lineTo(21.4, 18.8)
        ..cubicTo(21.4, 20.0, 20.4, 21.0, 19.2, 21.0)
        ..lineTo(4.8, 21.0)
        ..cubicTo(3.6, 21.0, 2.6, 20.0, 2.6, 18.8)
        ..lineTo(2.6, 11.5)
        ..cubicTo(2.6, 10.7, 2.9, 10.0, 3.6, 9.4)
        ..lineTo(10.4, 3.6)
        ..cubicTo(10.8, 3.2, 11.4, 2.8, 12.0, 2.8)
        ..close();
      paint.style = PaintingStyle.stroke;
      paint.strokeWidth = 2.0;
      paint.strokeCap = StrokeCap.round;

      // Inner door cutout for spatial modern silhouette
      ...
      // Sleek Monoline Outline with rounded vertex
...
class _ServicesIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ...
      ..strokeWidth = isSelected ? 0.0 : 1.85
      ..strokeCap = StrokeCap.round
      ..strokeJoin = StrokeJoin.round;
    final paint = Paint()..color = color;
    ...
    final RRect r1 = RRect.fromLTRBR(3.2, 3.2, 10.8, 10.8, const Radius.circular(radius));
    final RRect r2 = RRect.fromLTRBR(13.2, 3.2, 20.8, 10.8, const Radius.circular(radius));
    final RRect r3 = RRect.fromLTRBR(3.2, 13.2, 10.8, 20.8, const Radius.circular(radius));
    final RRect r4 = RRect.fromLTRBR(13.2, 13.2, 20.8, 20.8, const Radius.circular(radius));
      final path1 = Path()
        ..moveTo(5, 1)
        ..lineTo(9, 1)
        ..lineTo(9, 9)
...
class _BookingsIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isSelected) {
      ...
      // Contrast cutout details for modern filled look
      final Paint cutoutPaint = Paint()
        ..color = Colors.white
        ..style = PaintingStyle.fill;

      // Top Binder Pegs in active state
      canvas.drawRRect(
        RRect.fromLTRBR(6.8, 2.2, 9.2, 6.2, const Radius.circular(1.2)),
        cutoutPaint,
      );
      canvas.drawRRect(
        RRect.fromLTRBR(14.8, 2.2, 17.2, 6.2, const Radius.circular(1.2)),
        cutoutPaint,
      );

      // Date grid dots
      final Paint dotPaint = Paint()..color = Colors.white;
      canvas.drawCircle(const Offset(8.0, 13.0), 1.3, dotPaint);
      canvas.drawCircle(const Offset(12.0, 13.0), 1.3, dotPaint);
      canvas.drawCircle(const Offset(16.0, 13.0), 1.3, dotPaint);
      canvas.drawCircle(const Offset(8.0, 17.0), 1.3, dotPaint);
      canvas.drawCircle(const Offset(12.0, 17.0), 1.3, dotPaint);
      canvas.drawCircle(const Offset(16.0, 17.0), 1.3, dotPaint);
      paint.style = PaintingStyle.fill;
      final path1 = Path()
        ..moveTo(17.42, 1.83)
        ..lineTo(16.74, 1.83)
